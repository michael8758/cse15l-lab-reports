...
Throughout the second half of the quarter in CSE 15L, I was introduced to a lot of new concepts that I would be working with for the very first time. For example, working with Vim was something that I experienced for the first time in CSE 15L. I was originally astonished by all the possible shortcuts made possible by using Vim, and how much time it was capable of reducing when coding. This is also an especially importartant skill to be familiar with as Vim is mostly used in CSE 30, in which I will be taking next quarter, so having some general knowledge about Vim will come in handy next quarter. Another interesting concept that I learned in CSE 15L towards the second half of the quarter is the JDB debugger. I feel that this tool is especially important as I progresss my understanding of programming since I will be writing more complex codes, which results in more complex errors and bugs that need lots of time to be spent debugging. Overall, Being part of this class genuinely expanded my knowledge in terms of software tools, and I find many of the topics of this class to be useful and applicable to many future classes or career related tasks. 
